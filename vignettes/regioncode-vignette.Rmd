...
Current resources do not permit coverage of all such counties, an issue we plan to address in the future (see [todo](https://github.com/sammo3182/regioncode/issues/54)). 
...
We welcome collaboration, and users can direct any questions, comments, or bug reports to our [Github Issues](https://github.com/sammo3182/regioncode/issues) page.
